...
//    V1.0    M.Stojanovic     15 Aug 10     Initial version
...
///////////////////////////////////////////////////////////////////////////////
    ...
    parameter mem_file_name     = "none";//"s25fl256l.mem";
    parameter secr_file_name    = "s25fl256lSECR.mem";//"none";

    parameter TimingModel       = "DefaultTimingModel";

    parameter  PartID           = "s25fl256l";
    ...
    parameter  SecNum           = 13'h1FFF;
    parameter  BlockNum         = 9'h1FF;
    parameter  HalfBlockNum     = 10'h3FF;
    ...
    parameter  ManufIDDeviceID  = 24'h196001;
    parameter  DeviceID         = 16'h6019;
    parameter  UID              = 64'b0;
...
specify
    ...
    `ifdef SPEEDSIM
        ...
        specparam        tdevice_PP                = 900e6; //tPP = 900us
        // Byte Programming
        specparam        tdevice_BP1               = 25e6; //tBP1 = 25us
        // Byte Programming
        specparam        tdevice_BP2               = 20e6; //tBP2 = 20us
        // 4 KB Sector Erase Operation
        specparam        tdevice_SE                = 200e6; //tSE = 200us
        // 32 KB Half Block Erase Operation
        specparam        tdevice_HBE               = 363e6; //tHBE = 363us
       // 64 KB Block Erase Operation
        specparam        tdevice_BE                = 725e6; //tBE = 725us
        // Chip Erase Operation
        specparam        tdevice_CE                = 360e9; //tCE = 360ms
        // Suspend Latency
    ...
    `else
        ...
        specparam        tdevice_BP2               = 20e6; //tBP2 = 20us
        // 4 KB Sector Erase Operation
        specparam        tdevice_SE                = 200e9; //tSE = 200ms
        // 32 KB Half Block Erase Operation
        specparam        tdevice_HBE               = 363e9; //tHBE = 363ms
       // 64 KB Block Erase Operation
        specparam        tdevice_BE                = 725e9; //tBE = 725ms
        // Chip Erase Operation
        specparam        tdevice_CE                = 360e12; //tCE = 360s
        // Suspend Latency
        specparam        tdevice_SUSP              = 40e6; //tSL = 40us
        // Resume to next Suspend Time
        specparam        tdevice_RNS               = 100e6;//tRS = 100 us
...
///////////////////////////////////////////////////////////////////////////////
    ...
    begin: InitMemory
        ...
        begin
           // Memory Preload
           //s25fl256l.mem, memory preload file
...
//    /////////////////////////////////////////////////////////////////////////
    ...
    always @(PoweredUp, BP3, BP2, BP1, BP0, TBPROT, CMP)
    begin

        if (!CMP)
        begin
            Legacy_Sec_Prot = {(SecNum+1){1'b0}};
            case ({BP3,BP2,BP1,BP0})
            ...
            begin
                if (!TBPROT)
                    Legacy_Sec_Prot[SecNum : (SecNum-15)] = {16{1'b1}};
                else
                    Legacy_Sec_Prot[15 : 0] = {16{1'b1}};
            end
           ...
           4'b1001:
            begin
                if (!TBPROT)
                    Legacy_Sec_Prot[SecNum : (SecNum-4095)] = {4096{1'b1}};
                else
                    Legacy_Sec_Prot[4095 : 0] = {4096{1'b1}};
            end
        ...
        begin
            ...
            begin
                if (!TBPROT)
                    Legacy_Sec_Prot[SecNum : (SecNum-15)] = {16{1'b0}};
                else
                    Legacy_Sec_Prot[15 : 0] = {16{1'b0}};
            end
           ...
           4'b1001:
            begin
                if (!TBPROT)
                    Legacy_Sec_Prot[SecNum : (SecNum-4095)] = {4096{1'b0}};
                else
                    Legacy_Sec_Prot[4095 : 0] = {4096{1'b0}};
            end
